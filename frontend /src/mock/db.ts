...
export const itemStages: ItemStage[] = [
  ...
  { id: "stg_6k1_w", itemId: "obj_6_k1", stageType: "walkthrough", order: 2, prompt: "Let's walk through how the first law applies to an adiabatic process step by step." },
  ...
  { id: "stg_6k2_w", itemId: "obj_6_k2", stageType: "walkthrough", order: 2, prompt: "Let's explore how entropy relates to the second law of thermodynamics." },
  ...
  { id: "stg_6k3_w", itemId: "obj_6_k3", stageType: "walkthrough", order: 2, prompt: "Let's walk through the four stages of the Carnot cycle and why it represents maximum efficiency." },
  ...
  { id: "stg_6k4_w", itemId: "obj_6_k4", stageType: "walkthrough", order: 2, prompt: "Let's compare isothermal, adiabatic, isobaric, and isochoric processes on a PV diagram." },
  ...
  { id: "stg_6k5_w", itemId: "obj_6_k5", stageType: "walkthrough", order: 2, prompt: "Let's derive the relationship between average kinetic energy and temperature step by step." },
  ...
  { id: "stg_6s1_w", itemId: "obj_6_s1", stageType: "walkthrough", order: 2, prompt: "Let's work through calculating work done by an ideal gas in isothermal expansion." },
  ...
  { id: "stg_6s2_w", itemId: "obj_6_s2", stageType: "walkthrough", order: 2, prompt: "Let's walk through a calorimetry problem where a hot metal is dropped into cold water." },
  ...
  { id: "stg_6s3_w", itemId: "obj_6_s3", stageType: "walkthrough", order: 2, prompt: "Let's calculate the maximum theoretical efficiency of a power plant operating between 600K and 300K." },
  ...
  { id: "stg_6s4_w", itemId: "obj_6_s4", stageType: "walkthrough", order: 2, prompt: "Let's analyze a complete thermodynamic cycle on a PV diagram and calculate net work done." },
  ...
  { id: "stg_6s5_w", itemId: "obj_6_s5", stageType: "walkthrough", order: 2, prompt: "Let's calculate the total entropy change when a hot object is placed in contact with a cold reservoir." },
  ...
  // --- C1: Design a Heat Engine System ---
  { id: "stg_6c1_b", itemId: "obj_6_c1", stageType: "begin", order: 1, prompt: "What are the essential components of a heat engine system?" },
  { id: "stg_6c1_w", itemId: "obj_6_c1", stageType: "walkthrough", order: 2, prompt: "Let's design a simple heat engine step by step, choosing a working fluid, hot and cold reservoirs, and a thermodynamic cycle." },
  { id: "stg_6c1_c", itemId: "obj_6_c1", stageType: "challenge", order: 3, prompt: "Design a complete heat engine system for a small power plant. Specify the cycle type, working temperatures, expected efficiency, and explain all energy flows with calculations." },

  // ======================================================================
  //  UNIT 8 - MAGNETISM
  // ======================================================================

  // --- K1: Magnetic Fields Around Wires (COMPLETED - 3 stars) ---
  { id: "stg_8k1_b", itemId: "obj_8_k1", stageType: "begin", order: 1, prompt: "What creates a magnetic field around a wire?" },
  { id: "stg_8k1_w", itemId: "obj_8_k1", stageType: "walkthrough", order: 2, prompt: "Let's walk through the shape and direction of magnetic field lines around a current-carrying wire." },
  ...
  // --- K2: Electromagnets (2 stars - walkthrough done, on challenge) ---
  { id: "stg_8k2_b", itemId: "obj_8_k2", stageType: "begin", order: 1, prompt: "What is an electromagnet?" },
  { id: "stg_8k2_w", itemId: "obj_8_k2", stageType: "walkthrough", order: 2, prompt: "Let's work through how electromagnets work and how to increase their strength step by step." },
  ...
  // --- K3: Electromagnetic Induction (1 star - begin done, on walkthrough) ---
  { id: "stg_8k3_b", itemId: "obj_8_k3", stageType: "begin", order: 1, prompt: "What is electromagnetic induction?" },
  { id: "stg_8k3_w", itemId: "obj_8_k3", stageType: "walkthrough", order: 2, prompt: "Let's explore Faraday's law of electromagnetic induction step by step." },
  ...
  // --- K4: Lenz's Law (0 stars - not started) ---
  ...
  { id: "stg_8k4_w", itemId: "obj_8_k4", stageType: "walkthrough", order: 2, prompt: "Let's apply Lenz's law to several scenarios involving a magnet moving through a coil." },
  ...
  // --- K5: Magnetic Flux (3 stars - completed) ---
  ...
  { id: "stg_8k5_w", itemId: "obj_8_k5", stageType: "walkthrough", order: 2, prompt: "Let's work through how magnetic flux depends on field strength, area, and angle." },
  ...
  // --- K6: Magnetic Materials / Ferromagnetism (0 stars - not started) ---
  { id: "stg_8k6_b", itemId: "obj_8_k6", stageType: "begin", order: 1, prompt: "Why are some materials magnetic and others are not?" },
  { id: "stg_8k6_w", itemId: "obj_8_k6", stageType: "walkthrough", order: 2, prompt: "Let's explore magnetic domains, hysteresis, and what makes ferromagnetic materials special." },
  ...
  // --- K7: Earth's Magnetic Field (1 star - begin done, on walkthrough) ---
  { id: "stg_8k7_b", itemId: "obj_8_k7", stageType: "begin", order: 1, prompt: "What causes Earth's magnetic field?" },
  { id: "stg_8k7_w", itemId: "obj_8_k7", stageType: "walkthrough", order: 2, prompt: "Let's walk through the structure of Earth's magnetic field, including declination, inclination, and the magnetosphere." },
  ...
  // --- S1: Calculating B-field from Wire / Biot-Savart (3 stars - completed) ---
  ...
  { id: "stg_8s1_w", itemId: "obj_8_s1", stageType: "walkthrough", order: 2, prompt: "Let's calculate the magnetic field strength at a given distance from a current-carrying wire using the Biot-Savart law." },
  ...
  // --- S2: Solenoid Field Calculations (2 stars - walkthrough done, on challenge) ---
  ...
  { id: "stg_8s2_w", itemId: "obj_8_s2", stageType: "walkthrough", order: 2, prompt: "Let's work through calculating the magnetic field inside a solenoid step by step." },
  ...
  // --- S3: Faraday's Law Calculations (1 star - begin done, on walkthrough) ---
  ...
  { id: "stg_8s3_w", itemId: "obj_8_s3", stageType: "walkthrough", order: 2, prompt: "Let's calculate the EMF induced in a coil when the magnetic flux changes, using Faraday's law." },
  ...
  // --- S4: Transformer Calculations (0 stars - not started) ---
  ...
  { id: "stg_8s4_w", itemId: "obj_8_s4", stageType: "walkthrough", order: 2, prompt: "Let's work through transformer voltage and current ratios step by step." },
  ...
  // --- S5: Force on Moving Charges / Lorentz Force (0 stars - not started) ---
  ...
  { id: "stg_8s5_w", itemId: "obj_8_s5", stageType: "walkthrough", order: 2, prompt: "Let's calculate the Lorentz force on a charged particle and determine its circular path in a uniform field." },
  ...
  // --- S6: Magnetic Circuit Problems (3 stars - completed) ---
  ...
  { id: "stg_8s6_w", itemId: "obj_8_s6", stageType: "walkthrough", order: 2, prompt: "Let's work through analyzing a magnetic circuit using reluctance, magnetomotive force, and flux." },
  ...
  // --- C1: Design an Electric Motor (0 stars - not started) ---
  { id: "stg_8c1_b", itemId: "obj_8_c1", stageType: "begin", order: 1, prompt: "How do magnetic fields, electromagnets, and induction connect in real-world applications like electric motors?" },
  { id: "stg_8c1_w", itemId: "obj_8_c1", stageType: "walkthrough", order: 2, prompt: "Let's design a simple DC motor step by step, combining all magnetism concepts: field generation, force on conductors, commutation, and torque." },
  { id: "stg_8c1_c", itemId: "obj_8_c1", stageType: "challenge", order: 3, prompt: "Design and analyze a simple electric motor. Specify coil dimensions, number of turns, current, and field strength. Calculate the torque produced and explain the role of each magnetism principle in its operation." },

  // --- C2: Electromagnetic Wave Propagation Analysis (0 stars - not started) ---
  { id: "stg_8c2_b", itemId: "obj_8_c2", stageType: "begin", order: 1, prompt: "How are changing electric and magnetic fields related to the propagation of electromagnetic waves?" },
  { id: "stg_8c2_w", itemId: "obj_8_c2", stageType: "walkthrough", order: 2, prompt: "Let's trace how Maxwell's equations predict electromagnetic wave propagation, step by step from a changing current to a radiated wave." },
  { id: "stg_8c2_c", itemId: "obj_8_c2", stageType: "challenge", order: 3, prompt: "Derive the wave equation for electromagnetic waves from Maxwell's equations. Calculate the speed of propagation and explain the relationship between E and B field amplitudes in a plane wave." },

  // ======================================================================
  //  UNIT 1 - COLONIAL AMERICA (COMPLETED)
  // ======================================================================

  // --- K1: Jamestown Settlement (COMPLETED - 3 stars) ---
  ...
  { id: "stg_1k1_w", itemId: "obj_1_k1", stageType: "walkthrough", order: 2, prompt: "Let's walk through the key factors that nearly destroyed Jamestown and how John Smith and John Rolfe helped it survive." },
  ...
  // --- K2: Mayflower Compact (COMPLETED - 3 stars) ---
  { id: "stg_1k2_b", itemId: "obj_1_k2", stageType: "begin", order: 1, prompt: "What was the Mayflower Compact and why was it significant?" },
  { id: "stg_1k2_w", itemId: "obj_1_k2", stageType: "walkthrough", order: 2, prompt: "Let's examine the Mayflower Compact step by step: who wrote it, what it said, and how it established a precedent for self-government in America." },
  ...
  // --- K3: Colonial Government (COMPLETED - 3 stars) ---
  ...
  { id: "stg_1k3_w", itemId: "obj_1_k3", stageType: "walkthrough", order: 2, prompt: "Let's compare royal, proprietary, and charter colonies and how each type of colonial government operated." },
  ...
  // --- K4: Mercantilism (COMPLETED - 3 stars) ---
  ...
  { id: "stg_1k4_w", itemId: "obj_1_k4", stageType: "walkthrough", order: 2, prompt: "Let's trace how the Navigation Acts enforced mercantilist policies and how colonists responded to trade restrictions." },
  ...
  // --- K5: Great Awakening (COMPLETED - 3 stars) ---
  { id: "stg_1k5_b", itemId: "obj_1_k5", stageType: "begin", order: 1, prompt: "What was the Great Awakening and when did it occur?" },
  { id: "stg_1k5_w", itemId: "obj_1_k5", stageType: "walkthrough", order: 2, prompt: "Let's explore how preachers like Jonathan Edwards and George Whitefield transformed colonial religious life and social structures." },
  ...
  // --- S1: Primary Source Analysis (COMPLETED - 3 stars) ---
  ...
  { id: "stg_1s1_w", itemId: "obj_1_s1", stageType: "walkthrough", order: 2, prompt: "Let's practice the SOAP method (Speaker, Occasion, Audience, Purpose) to analyze a primary source from the colonial period step by step." },
  ...
  // --- S2: Map Reading / Colonial Geography (COMPLETED - 3 stars) ---
  ...
  { id: "stg_1s2_w", itemId: "obj_1_s2", stageType: "walkthrough", order: 2, prompt: "Let's examine how geography influenced settlement patterns, economic activities, and cultural development in each colonial region." },
  ...
  // --- S3: Comparing Colonial Regions (COMPLETED - 3 stars) ---
  ...
  { id: "stg_1s3_w", itemId: "obj_1_s3", stageType: "walkthrough", order: 2, prompt: "Let's build a comparison chart examining economy, religion, social structure, and labor systems across the three colonial regions." },
  ...
  // --- S4: Timeline Construction (COMPLETED - 3 stars) ---
  ...
  { id: "stg_1s4_w", itemId: "obj_1_s4", stageType: "walkthrough", order: 2, prompt: "Let's construct a detailed timeline of Colonial America from 1607 to 1763, identifying cause-and-effect relationships between events." },
  ...
  // --- S5: Persuasive Essay Writing (COMPLETED - 3 stars) ---
  { id: "stg_1s5_b", itemId: "obj_1_s5", stageType: "begin", order: 1, prompt: "What are the key elements of a persuasive historical essay?" },
  { id: "stg_1s5_w", itemId: "obj_1_s5", stageType: "walkthrough", order: 2, prompt: "Let's outline a persuasive essay about colonial life, working through thesis, evidence, counterarguments, and conclusion step by step." },
  ...
  // --- C1: Was Colonial America a Land of Opportunity? (COMPLETED - 3 stars) ---
  { id: "stg_1c1_b", itemId: "obj_1_c1", stageType: "begin", order: 1, prompt: "In your own words, what does 'land of opportunity' mean in the context of Colonial America?" },
  { id: "stg_1c1_w", itemId: "obj_1_c1", stageType: "walkthrough", order: 2, prompt: "Let's examine the experiences of different groups in colonial America -- wealthy landowners, indentured servants, enslaved Africans, women, and Native Americans -- to build a nuanced answer." },
  { id: "stg_1c1_c", itemId: "obj_1_c1", stageType: "challenge", order: 3, prompt: "Write a thesis-driven essay answering: Was Colonial America truly a land of opportunity? Consider at least three different social groups and use specific historical evidence to support your argument." },

  // ======================================================================
  //  UNIT 2 - REVOLUTIONARY WAR (ACTIVE / MIXED PROGRESS)
  // ======================================================================

  // --- K1: Causes of Revolution (COMPLETED - 3 stars) ---
  { id: "stg_2k1_b", itemId: "obj_2_k1", stageType: "begin", order: 1, prompt: "What were the main causes of the American Revolution?" },
  { id: "stg_2k1_w", itemId: "obj_2_k1", stageType: "walkthrough", order: 2, prompt: "Let's trace the chain of events from the French and Indian War through the Intolerable Acts, examining how each event escalated colonial resistance." },
  ...
  // --- K2: Boston Tea Party (COMPLETED - 3 stars) ---
  ...
  { id: "stg_2k2_w", itemId: "obj_2_k2", stageType: "walkthrough", order: 2, prompt: "Let's examine the Boston Tea Party in context: the Tea Act, the role of the Sons of Liberty, and how Britain responded with the Intolerable Acts." },
  ...
  // --- K3: Declaration of Independence (2 stars - walkthrough done, on challenge) ---
  ...
  { id: "stg_2k3_w", itemId: "obj_2_k3", stageType: "walkthrough", order: 2, prompt: "Let's break down the Declaration of Independence section by section: the preamble, the list of grievances, and the formal declaration, examining how Enlightenment ideas influenced each part." },
  ...
  // --- K4: Key Battles (1 star - begin done, on walkthrough) ---
  ...
  { id: "stg_2k4_w", itemId: "obj_2_k4", stageType: "walkthrough", order: 2, prompt: "Let's analyze the turning points of the war: Lexington and Concord, Saratoga, and Yorktown, examining strategy, leadership, and consequences of each battle." },
  ...
  // --- K5: Foreign Alliances (0 stars - not started) ---
  ...
  { id: "stg_2k5_w", itemId: "obj_2_k5", stageType: "walkthrough", order: 2, prompt: "Let's examine how Benjamin Franklin secured the French alliance and how French military and financial aid changed the course of the war." },
  ...
  // --- K6: Treaty of Paris (0 stars - not started) ---
  { id: "stg_2k6_b", itemId: "obj_2_k6", stageType: "begin", order: 1, prompt: "What were the key terms of the Treaty of Paris of 1783?" },
  { id: "stg_2k6_w", itemId: "obj_2_k6", stageType: "walkthrough", order: 2, prompt: "Let's walk through the negotiations that led to the Treaty of Paris, examining what each side wanted and what they actually got." },
  ...
  // --- S1: Analyzing Political Cartoons (COMPLETED - 3 stars) ---
  ...
  { id: "stg_2s1_w", itemId: "obj_2_s1", stageType: "walkthrough", order: 2, prompt: "Let's analyze Benjamin Franklin's 'Join, or Die' cartoon step by step, identifying symbols, audience, purpose, and historical context." },
  ...
  // --- S2: Comparing Perspectives (2 stars - walkthrough done, on challenge) ---
  ...
  { id: "stg_2s2_w", itemId: "obj_2_s2", stageType: "walkthrough", order: 2, prompt: "Let's compare how Patriots, Loyalists, and neutral colonists viewed the same events differently, using the Stamp Act crisis as our case study." },
  ...
  // --- S3: Evaluating Primary Sources (1 star - begin done, on walkthrough) ---
  ...
  { id: "stg_2s3_w", itemId: "obj_2_s3", stageType: "walkthrough", order: 2, prompt: "Let's evaluate Thomas Paine's 'Common Sense' as a primary source, applying criteria of authorship, context, purpose, and reliability step by step." },
  ...
  // --- S4: Cause and Effect Diagrams (0 stars - not started) ---
  ...
  { id: "stg_2s4_w", itemId: "obj_2_s4", stageType: "walkthrough", order: 2, prompt: "Let's build a cause-and-effect diagram tracing how the French and Indian War led to increased taxation, which led to colonial protest, which led to revolution." },
  ...
  // --- S5: Argumentative Writing (0 stars - not started) ---
  ...
  { id: "stg_2s5_w", itemId: "obj_2_s5", stageType: "walkthrough", order: 2, prompt: "Let's craft an argumentative thesis about the Revolution and build supporting paragraphs with evidence, counterarguments, and rebuttals." },
  ...
  // --- C1: Was the Revolution Inevitable? (0 stars - not started) ---
  { id: "stg_2c1_b", itemId: "obj_2_c1", stageType: "begin", order: 1, prompt: "Do you think the American Revolution was inevitable, or could it have been avoided? Give your initial thoughts." },
  { id: "stg_2c1_w", itemId: "obj_2_c1", stageType: "walkthrough", order: 2, prompt: "Let's examine key moments where the conflict could have been resolved peacefully -- the Olive Branch Petition, various compromise proposals, and British policy decisions -- to test whether revolution was truly inevitable." },
  { id: "stg_2c1_c", itemId: "obj_2_c1", stageType: "challenge", order: 3, prompt: "Write a thesis-driven essay answering: Was the American Revolution inevitable? Consider at least three turning points where a different decision could have changed the outcome, and argue whether structural forces or individual choices mattered more." },
];
...
export const studentObjectiveProgress: StudentObjectiveProgress[] = [
  ...
  { studentId: "stu_1", objectiveId: "obj_6_k1", earnedStars: 3, currentStageType: "challenge", updatedAt: "2024-01-10T15:00:00Z" },
  { studentId: "stu_1", objectiveId: "obj_6_k2", earnedStars: 3, currentStageType: "challenge", updatedAt: "2024-01-11T14:00:00Z" },
  { studentId: "stu_1", objectiveId: "obj_6_k3", earnedStars: 0, currentStageType: "begin", updatedAt: "2024-01-11T15:00:00Z" },
  { studentId: "stu_1", objectiveId: "obj_6_k4", earnedStars: 0, currentStageType: "begin", updatedAt: "2024-01-11T15:00:00Z" },
  { studentId: "stu_1", objectiveId: "obj_6_k5", earnedStars: 0, currentStageType: "begin", updatedAt: "2024-01-11T15:00:00Z" },
  // S1 completed; rest not started
  { studentId: "stu_1", objectiveId: "obj_6_s1", earnedStars: 3, currentStageType: "challenge", updatedAt: "2024-01-12T16:00:00Z" },
  { studentId: "stu_1", objectiveId: "obj_6_s2", earnedStars: 0, currentStageType: "begin", updatedAt: "2024-01-12T16:00:00Z" },
  { studentId: "stu_1", objectiveId: "obj_6_s3", earnedStars: 0, currentStageType: "begin", updatedAt: "2024-01-12T16:00:00Z" },
  { studentId: "stu_1", objectiveId: "obj_6_s4", earnedStars: 0, currentStageType: "begin", updatedAt: "2024-01-12T16:00:00Z" },
  { studentId: "stu_1", objectiveId: "obj_6_s5", earnedStars: 0, currentStageType: "begin", updatedAt: "2024-01-12T16:00:00Z" },
  // C1 not started
  { studentId: "stu_1", objectiveId: "obj_6_c1", earnedStars: 0, currentStageType: "begin", updatedAt: "2024-01-12T16:00:00Z" },

  // -------- Unit 8 - Magnetism (MIXED PROGRESS) --------
  // K1: completed (3 stars)
  { studentId: "stu_1", objectiveId: "obj_8_k1", earnedStars: 3, currentStageType: "challenge", updatedAt: "2024-01-15T10:30:00Z" },
  // K2: walkthrough done (2 stars, on challenge)
  { studentId: "stu_1", objectiveId: "obj_8_k2", earnedStars: 2, currentStageType: "challenge", updatedAt: "2024-01-15T11:15:00Z" },
  // K3: begin done (1 star, on walkthrough)
  { studentId: "stu_1", objectiveId: "obj_8_k3", earnedStars: 1, currentStageType: "walkthrough", updatedAt: "2024-01-15T11:30:00Z" },
  // K4: not started (0 stars)
  { studentId: "stu_1", objectiveId: "obj_8_k4", earnedStars: 0, currentStageType: "begin", updatedAt: "2024-01-15T11:30:00Z" },
  // K5: completed (3 stars)
  { studentId: "stu_1", objectiveId: "obj_8_k5", earnedStars: 3, currentStageType: "challenge", updatedAt: "2024-01-15T14:00:00Z" },
  // K6: not started (0 stars)
  { studentId: "stu_1", objectiveId: "obj_8_k6", earnedStars: 0, currentStageType: "begin", updatedAt: "2024-01-15T14:00:00Z" },
  // K7: begin done (1 star, on walkthrough)
  { studentId: "stu_1", objectiveId: "obj_8_k7", earnedStars: 1, currentStageType: "walkthrough", updatedAt: "2024-01-15T14:30:00Z" },
  // S1: completed (3 stars)
  { studentId: "stu_1", objectiveId: "obj_8_s1", earnedStars: 3, currentStageType: "challenge", updatedAt: "2024-01-15T12:15:00Z" },
  // S2: walkthrough done (2 stars, on challenge)
  { studentId: "stu_1", objectiveId: "obj_8_s2", earnedStars: 2, currentStageType: "challenge", updatedAt: "2024-01-15T12:45:00Z" },
  // S3: begin done (1 star, on walkthrough)
  { studentId: "stu_1", objectiveId: "obj_8_s3", earnedStars: 1, currentStageType: "walkthrough", updatedAt: "2024-01-15T13:00:00Z" },
  // S4: not started (0 stars)
  { studentId: "stu_1", objectiveId: "obj_8_s4", earnedStars: 0, currentStageType: "begin", updatedAt: "2024-01-15T13:00:00Z" },
  // S5: not started (0 stars)
  { studentId: "stu_1", objectiveId: "obj_8_s5", earnedStars: 0, currentStageType: "begin", updatedAt: "2024-01-15T13:00:00Z" },
  // S6: completed (3 stars)
  { studentId: "stu_1", objectiveId: "obj_8_s6", earnedStars: 3, currentStageType: "challenge", updatedAt: "2024-01-15T15:00:00Z" },
  // C1: not started (0 stars)
  { studentId: "stu_1", objectiveId: "obj_8_c1", earnedStars: 0, currentStageType: "begin", updatedAt: "2024-01-15T15:00:00Z" },
  // C2: not started (0 stars)
  { studentId: "stu_1", objectiveId: "obj_8_c2", earnedStars: 0, currentStageType: "begin", updatedAt: "2024-01-15T15:00:00Z" },

  // -------- Unit 1 - Colonial America (ALL COMPLETED - 3 stars each) --------
  { studentId: "stu_1", objectiveId: "obj_1_k1", earnedStars: 3, currentStageType: "challenge", updatedAt: "2024-01-02T10:00:00Z" },
  { studentId: "stu_1", objectiveId: "obj_1_k2", earnedStars: 3, currentStageType: "challenge", updatedAt: "2024-01-02T11:00:00Z" },
  { studentId: "stu_1", objectiveId: "obj_1_k3", earnedStars: 3, currentStageType: "challenge", updatedAt: "2024-01-02T12:00:00Z" },
  { studentId: "stu_1", objectiveId: "obj_1_k4", earnedStars: 3, currentStageType: "challenge", updatedAt: "2024-01-02T13:00:00Z" },
  { studentId: "stu_1", objectiveId: "obj_1_k5", earnedStars: 3, currentStageType: "challenge", updatedAt: "2024-01-02T14:00:00Z" },
  { studentId: "stu_1", objectiveId: "obj_1_s1", earnedStars: 3, currentStageType: "challenge", updatedAt: "2024-01-03T10:00:00Z" },
  { studentId: "stu_1", objectiveId: "obj_1_s2", earnedStars: 3, currentStageType: "challenge", updatedAt: "2024-01-03T11:00:00Z" },
  { studentId: "stu_1", objectiveId: "obj_1_s3", earnedStars: 3, currentStageType: "challenge", updatedAt: "2024-01-03T12:00:00Z" },
  { studentId: "stu_1", objectiveId: "obj_1_s4", earnedStars: 3, currentStageType: "challenge", updatedAt: "2024-01-03T13:00:00Z" },
  { studentId: "stu_1", objectiveId: "obj_1_s5", earnedStars: 3, currentStageType: "challenge", updatedAt: "2024-01-03T14:00:00Z" },
  { studentId: "stu_1", objectiveId: "obj_1_c1", earnedStars: 3, currentStageType: "challenge", updatedAt: "2024-01-04T10:00:00Z" },

  // -------- Unit 2 - Revolutionary War (MIXED PROGRESS) --------
  // K1: completed (3 stars)
  { studentId: "stu_1", objectiveId: "obj_2_k1", earnedStars: 3, currentStageType: "challenge", updatedAt: "2024-01-06T10:00:00Z" },
  // K2: completed (3 stars)
  { studentId: "stu_1", objectiveId: "obj_2_k2", earnedStars: 3, currentStageType: "challenge", updatedAt: "2024-01-06T11:00:00Z" },
  // K3: walkthrough done (2 stars, on challenge)
  { studentId: "stu_1", objectiveId: "obj_2_k3", earnedStars: 2, currentStageType: "challenge", updatedAt: "2024-01-06T12:00:00Z" },
  // K4: begin done (1 star, on walkthrough)
  { studentId: "stu_1", objectiveId: "obj_2_k4", earnedStars: 1, currentStageType: "walkthrough", updatedAt: "2024-01-06T13:00:00Z" },
  // K5: not started (0 stars)
  { studentId: "stu_1", objectiveId: "obj_2_k5", earnedStars: 0, currentStageType: "begin", updatedAt: "2024-01-06T13:00:00Z" },
  // K6: not started (0 stars)
  { studentId: "stu_1", objectiveId: "obj_2_k6", earnedStars: 0, currentStageType: "begin", updatedAt: "2024-01-06T13:00:00Z" },
  // S1: completed (3 stars)
  { studentId: "stu_1", objectiveId: "obj_2_s1", earnedStars: 3, currentStageType: "challenge", updatedAt: "2024-01-07T10:00:00Z" },
  // S2: walkthrough done (2 stars, on challenge)
  { studentId: "stu_1", objectiveId: "obj_2_s2", earnedStars: 2, currentStageType: "challenge", updatedAt: "2024-01-07T11:00:00Z" },
  // S3: begin done (1 star, on walkthrough)
  { studentId: "stu_1", objectiveId: "obj_2_s3", earnedStars: 1, currentStageType: "walkthrough", updatedAt: "2024-01-07T12:00:00Z" },
  // S4: not started (0 stars)
  { studentId: "stu_1", objectiveId: "obj_2_s4", earnedStars: 0, currentStageType: "begin", updatedAt: "2024-01-07T12:00:00Z" },
  // S5: not started (0 stars)
  { studentId: "stu_1", objectiveId: "obj_2_s5", earnedStars: 0, currentStageType: "begin", updatedAt: "2024-01-07T12:00:00Z" },
  // C1: not started (0 stars)
  { studentId: "stu_1", objectiveId: "obj_2_c1", earnedStars: 0, currentStageType: "begin", updatedAt: "2024-01-07T12:00:00Z" },
];
...
export const chatThreads: ChatThread[] = [
  ...
  { id: "thr_6_c1", unitId: "unit_ph_6", courseId: "crs_2", objectiveId: "obj_6_c1", title: "Capstone 1", kind: "capstone", lastMessageAt: "2024-01-12T16:00:00Z" },
  ...
  { id: "thr_8_c1", unitId: "unit_ph_8", courseId: "crs_2", objectiveId: "obj_8_c1", title: "Capstone 1", kind: "capstone", lastMessageAt: "2024-01-15T15:00:00Z" },
  { id: "thr_8_c2", unitId: "unit_ph_8", courseId: "crs_2", objectiveId: "obj_8_c2", title: "Capstone 2", kind: "capstone", lastMessageAt: "2024-01-15T15:00:00Z" },
  ...
  { id: "thr_1_c1", unitId: "unit_ah_1", courseId: "crs_1", objectiveId: "obj_1_c1", title: "Capstone 1", kind: "capstone", lastMessageAt: "2024-01-04T10:00:00Z" },
  ...
  { id: "thr_2_c1", unitId: "unit_ah_2", courseId: "crs_1", objectiveId: "obj_2_c1", title: "Capstone 1", kind: "capstone", lastMessageAt: "2024-01-07T12:00:00Z" },
];
...
export const chatMessages: ChatMessage[] = [
  ...
  // ========== Thread 6_k1 - First Law of Thermodynamics (COMPLETED - 3 stars) ==========
  ...
  { id: "msg_6k1_2", threadId: "thr_6_k1", stageId: "stg_6k1_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-10T13:15:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  // Walkthrough stage
  ...
  { id: "msg_6k1_7", threadId: "thr_6_k1", stageId: "stg_6k1_w", role: "tutor", content: "\u2b50\u2b50 Walkthrough complete", createdAt: "2024-01-10T13:40:00Z", metadata: { isSystemMessage: true, earnedStars: 2, isCompletionMessage: true } },
  // Challenge stage
  ...
  { id: "msg_6k1_9", threadId: "thr_6_k1", stageId: "stg_6k1_c", role: "tutor", content: "\u2b50\u2b50\u2b50 Challenge complete!", createdAt: "2024-01-10T14:35:00Z", metadata: { isSystemMessage: true, earnedStars: 3, isCompletionMessage: true } },

  // ========== Thread 6_k2 - Entropy and the Second Law (COMPLETED - 3 stars) ==========
  ...
  { id: "msg_6k2_2", threadId: "thr_6_k2", stageId: "stg_6k2_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-11T12:05:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  // Walkthrough stage
  ...
  { id: "msg_6k2_7", threadId: "thr_6_k2", stageId: "stg_6k2_w", role: "tutor", content: "\u2b50\u2b50 Walkthrough complete", createdAt: "2024-01-11T12:30:00Z", metadata: { isSystemMessage: true, earnedStars: 2, isCompletionMessage: true } },
  // Challenge stage
  ...
  { id: "msg_6k2_9", threadId: "thr_6_k2", stageId: "stg_6k2_c", role: "tutor", content: "\u2b50\u2b50\u2b50 Challenge complete!", createdAt: "2024-01-11T13:35:00Z", metadata: { isSystemMessage: true, earnedStars: 3, isCompletionMessage: true } },

  // ========== Thread 6_s1 - Work in Gas Expansion (COMPLETED - 3 stars) ==========
  ...
  { id: "msg_6s1_2", threadId: "thr_6_s1", stageId: "stg_6s1_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-12T14:05:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  // Walkthrough stage
  ...
  { id: "msg_6s1_7", threadId: "thr_6_s1", stageId: "stg_6s1_w", role: "tutor", content: "\u2b50\u2b50 Walkthrough complete", createdAt: "2024-01-12T14:30:00Z", metadata: { isSystemMessage: true, earnedStars: 2, isCompletionMessage: true } },
  // Challenge stage
  ...
  { id: "msg_6s1_9", threadId: "thr_6_s1", stageId: "stg_6s1_c", role: "tutor", content: "\u2b50\u2b50\u2b50 Challenge complete!", createdAt: "2024-01-12T15:35:00Z", metadata: { isSystemMessage: true, earnedStars: 3, isCompletionMessage: true } },

  // Threads 6_k3, 6_k4, 6_k5, 6_s2, 6_s3, 6_s4, 6_s5, 6_c1 - no messages (0 stars, not started)

  // ======================================================================
  //  UNIT 8 MESSAGES
  // ======================================================================

  // ========== Thread 8_k1 - Magnetic Fields Around Wires (COMPLETED - 3 stars) ==========
  ...
  { id: "msg_8k1_2", threadId: "thr_8_k1", stageId: "stg_8k1_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-15T09:15:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  // Walkthrough stage
  ...
  { id: "msg_8k1_7", threadId: "thr_8_k1", stageId: "stg_8k1_w", role: "tutor", content: "\u2b50\u2b50 Walkthrough complete", createdAt: "2024-01-15T09:35:00Z", metadata: { isSystemMessage: true, earnedStars: 2, isCompletionMessage: true } },
  // Challenge stage
  ...
  { id: "msg_8k1_9", threadId: "thr_8_k1", stageId: "stg_8k1_c", role: "tutor", content: "\u2b50\u2b50\u2b50 Challenge complete!", createdAt: "2024-01-15T10:20:00Z", metadata: { isSystemMessage: true, earnedStars: 3, isCompletionMessage: true } },

  // ========== Thread 8_k2 - Electromagnets (2 stars - walkthrough done, on challenge) ==========
  ...
  { id: "msg_8k2_2", threadId: "thr_8_k2", stageId: "stg_8k2_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-15T10:45:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  ...
  { id: "msg_8k2_9", threadId: "thr_8_k2", stageId: "stg_8k2_w", role: "tutor", content: "\u2b50\u2b50 Walkthrough complete", createdAt: "2024-01-15T11:05:00Z", metadata: { isSystemMessage: true, earnedStars: 2, isCompletionMessage: true } },
  ...
  // ========== Thread 8_k3 - Electromagnetic Induction (1 star - begin done, on walkthrough) ==========
  ...
  { id: "msg_8k3_2", threadId: "thr_8_k3", stageId: "stg_8k3_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-15T11:25:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  ...
  // Thread 8_k4 - Lenz's Law (0 stars - NOT STARTED) - no messages

  // ========== Thread 8_k5 - Magnetic Flux (COMPLETED - 3 stars) ==========
  ...
  { id: "msg_8k5_2", threadId: "thr_8_k5", stageId: "stg_8k5_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-15T13:05:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  // Walkthrough stage
  ...
  { id: "msg_8k5_7", threadId: "thr_8_k5", stageId: "stg_8k5_w", role: "tutor", content: "\u2b50\u2b50 Walkthrough complete", createdAt: "2024-01-15T13:25:00Z", metadata: { isSystemMessage: true, earnedStars: 2, isCompletionMessage: true } },
  // Challenge stage
  ...
  { id: "msg_8k5_9", threadId: "thr_8_k5", stageId: "stg_8k5_c", role: "tutor", content: "\u2b50\u2b50\u2b50 Challenge complete!", createdAt: "2024-01-15T13:55:00Z", metadata: { isSystemMessage: true, earnedStars: 3, isCompletionMessage: true } },

  // Thread 8_k6 - Magnetic Materials (0 stars - NOT STARTED) - no messages

  // ========== Thread 8_k7 - Earth's Magnetic Field (1 star - begin done, on walkthrough) ==========
  ...
  { id: "msg_8k7_2", threadId: "thr_8_k7", stageId: "stg_8k7_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-15T14:15:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  ...
  // ========== Thread 8_s1 - Calculating B-field / Biot-Savart (COMPLETED - 3 stars) ==========
  ...
  { id: "msg_8s1_2", threadId: "thr_8_s1", stageId: "stg_8s1_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-15T11:45:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  ...
  { id: "msg_8s1_7", threadId: "thr_8_s1", stageId: "stg_8s1_w", role: "tutor", content: "\u2b50\u2b50 Walkthrough complete", createdAt: "2024-01-15T12:00:00Z", metadata: { isSystemMessage: true, earnedStars: 2, isCompletionMessage: true } },
  // Challenge stage
  ...
  { id: "msg_8s1_9", threadId: "thr_8_s1", stageId: "stg_8s1_c", role: "tutor", content: "\u2b50\u2b50\u2b50 Challenge complete!", createdAt: "2024-01-15T12:15:00Z", metadata: { isSystemMessage: true, earnedStars: 3, isCompletionMessage: true } },

  // ========== Thread 8_s2 - Solenoid Field Calculations (2 stars - walkthrough done, on challenge) ==========
  ...
  { id: "msg_8s2_2", threadId: "thr_8_s2", stageId: "stg_8s2_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-15T12:25:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  // Walkthrough stage - rich tutor flow
  ...
  { id: "msg_8s2_7", threadId: "thr_8_s2", stageId: "stg_8s2_w", role: "tutor", content: "\u2b50\u2b50 Walkthrough complete", createdAt: "2024-01-15T12:38:00Z", metadata: { isSystemMessage: true, earnedStars: 2, isCompletionMessage: true } },
  ...
  // ========== Thread 8_s3 - Faraday's Law Calculations (1 star - begin done, on walkthrough) ==========
  ...
  { id: "msg_8s3_2", threadId: "thr_8_s3", stageId: "stg_8s3_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-15T12:55:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  // Walkthrough just started
  ...
  // Thread 8_s4 - Transformer Calculations (0 stars - NOT STARTED) - no messages
  // Thread 8_s5 - Lorentz Force (0 stars - NOT STARTED) - no messages

  // ========== Thread 8_s6 - Magnetic Circuit Problems (COMPLETED - 3 stars) ==========
  ...
  { id: "msg_8s6_2", threadId: "thr_8_s6", stageId: "stg_8s6_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-15T14:45:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  // Walkthrough stage
  ...
  { id: "msg_8s6_7", threadId: "thr_8_s6", stageId: "stg_8s6_w", role: "tutor", content: "\u2b50\u2b50 Walkthrough complete", createdAt: "2024-01-15T14:59:00Z", metadata: { isSystemMessage: true, earnedStars: 2, isCompletionMessage: true } },
  // Challenge stage
  ...
  { id: "msg_8s6_9", threadId: "thr_8_s6", stageId: "stg_8s6_c", role: "tutor", content: "\u2b50\u2b50\u2b50 Challenge complete!", createdAt: "2024-01-15T15:00:00Z", metadata: { isSystemMessage: true, earnedStars: 3, isCompletionMessage: true } },

  // Thread 8_c1 - Design an Electric Motor (0 stars - NOT STARTED) - no messages
  // Thread 8_c2 - Electromagnetic Wave Propagation Analysis (0 stars - NOT STARTED) - no messages

  // ======================================================================
  //  UNIT 1 MESSAGES - COLONIAL AMERICA (ALL COMPLETED)
  // ======================================================================

  // ========== Thread 1_k1 - Jamestown Settlement (COMPLETED - 3 stars) ==========
  ...
  { id: "msg_1k1_2", threadId: "thr_1_k1", stageId: "stg_1k1_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-02T09:15:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  ...
  { id: "msg_1k1_9", threadId: "thr_1_k1", stageId: "stg_1k1_w", role: "tutor", content: "\u2b50\u2b50 Walkthrough complete", createdAt: "2024-01-02T09:50:00Z", metadata: { isSystemMessage: true, earnedStars: 2, isCompletionMessage: true } },
  // Challenge stage
  ...
  { id: "msg_1k1_11", threadId: "thr_1_k1", stageId: "stg_1k1_c", role: "tutor", content: "\u2b50\u2b50\u2b50 Challenge complete!", createdAt: "2024-01-02T10:00:00Z", metadata: { isSystemMessage: true, earnedStars: 3, isCompletionMessage: true } },

  // ========== Thread 1_k2 - Mayflower Compact (COMPLETED - 3 stars) ==========
  ...
  { id: "msg_1k2_2", threadId: "thr_1_k2", stageId: "stg_1k2_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-02T10:15:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  // Walkthrough stage - rich Socratic tutor flow
  ...
  { id: "msg_1k2_9", threadId: "thr_1_k2", stageId: "stg_1k2_w", role: "tutor", content: "\u2b50\u2b50 Walkthrough complete", createdAt: "2024-01-02T10:50:00Z", metadata: { isSystemMessage: true, earnedStars: 2, isCompletionMessage: true } },
  // Challenge stage
  ...
  { id: "msg_1k2_11", threadId: "thr_1_k2", stageId: "stg_1k2_c", role: "tutor", content: "\u2b50\u2b50\u2b50 Challenge complete!", createdAt: "2024-01-02T11:00:00Z", metadata: { isSystemMessage: true, earnedStars: 3, isCompletionMessage: true } },

  // ========== Thread 1_k3 - Colonial Government (COMPLETED - 3 stars) ==========
  ...
  { id: "msg_1k3_2", threadId: "thr_1_k3", stageId: "stg_1k3_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-02T11:15:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  // Walkthrough stage
  ...
  { id: "msg_1k3_5", threadId: "thr_1_k3", stageId: "stg_1k3_w", role: "tutor", content: "\u2b50\u2b50 Walkthrough complete", createdAt: "2024-01-02T11:30:00Z", metadata: { isSystemMessage: true, earnedStars: 2, isCompletionMessage: true } },
  // Challenge stage
  ...
  { id: "msg_1k3_7", threadId: "thr_1_k3", stageId: "stg_1k3_c", role: "tutor", content: "\u2b50\u2b50\u2b50 Challenge complete!", createdAt: "2024-01-02T12:00:00Z", metadata: { isSystemMessage: true, earnedStars: 3, isCompletionMessage: true } },

  // ========== Thread 1_k4 - Mercantilism (COMPLETED - 3 stars) ==========
  ...
  { id: "msg_1k4_2", threadId: "thr_1_k4", stageId: "stg_1k4_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-02T12:15:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  // Walkthrough stage
  ...
  { id: "msg_1k4_5", threadId: "thr_1_k4", stageId: "stg_1k4_w", role: "tutor", content: "\u2b50\u2b50 Walkthrough complete", createdAt: "2024-01-02T12:30:00Z", metadata: { isSystemMessage: true, earnedStars: 2, isCompletionMessage: true } },
  // Challenge stage
  ...
  { id: "msg_1k4_7", threadId: "thr_1_k4", stageId: "stg_1k4_c", role: "tutor", content: "\u2b50\u2b50\u2b50 Challenge complete!", createdAt: "2024-01-02T13:00:00Z", metadata: { isSystemMessage: true, earnedStars: 3, isCompletionMessage: true } },

  // ========== Thread 1_k5 - Great Awakening (COMPLETED - 3 stars) ==========
  ...
  { id: "msg_1k5_2", threadId: "thr_1_k5", stageId: "stg_1k5_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-02T13:15:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  // Walkthrough stage
  ...
  { id: "msg_1k5_5", threadId: "thr_1_k5", stageId: "stg_1k5_w", role: "tutor", content: "\u2b50\u2b50 Walkthrough complete", createdAt: "2024-01-02T13:30:00Z", metadata: { isSystemMessage: true, earnedStars: 2, isCompletionMessage: true } },
  // Challenge stage
  ...
  { id: "msg_1k5_7", threadId: "thr_1_k5", stageId: "stg_1k5_c", role: "tutor", content: "\u2b50\u2b50\u2b50 Challenge complete!", createdAt: "2024-01-02T14:00:00Z", metadata: { isSystemMessage: true, earnedStars: 3, isCompletionMessage: true } },

  // ========== Thread 1_s1 - Primary Source Analysis (COMPLETED - 3 stars) ==========
  ...
  { id: "msg_1s1_2", threadId: "thr_1_s1", stageId: "stg_1s1_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-03T09:15:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  // Walkthrough stage - rich Socratic tutor flow
  ...
  { id: "msg_1s1_9", threadId: "thr_1_s1", stageId: "stg_1s1_w", role: "tutor", content: "\u2b50\u2b50 Walkthrough complete", createdAt: "2024-01-03T09:50:00Z", metadata: { isSystemMessage: true, earnedStars: 2, isCompletionMessage: true } },
  // Challenge stage
  ...
  { id: "msg_1s1_11", threadId: "thr_1_s1", stageId: "stg_1s1_c", role: "tutor", content: "\u2b50\u2b50\u2b50 Challenge complete!", createdAt: "2024-01-03T10:00:00Z", metadata: { isSystemMessage: true, earnedStars: 3, isCompletionMessage: true } },

  // ========== Thread 1_s2 - Map Reading / Colonial Geography (COMPLETED - 3 stars) ==========
  ...
  { id: "msg_1s2_2", threadId: "thr_1_s2", stageId: "stg_1s2_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-03T10:15:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  // Walkthrough stage - rich Socratic tutor flow
  ...
  { id: "msg_1s2_9", threadId: "thr_1_s2", stageId: "stg_1s2_w", role: "tutor", content: "\u2b50\u2b50 Walkthrough complete", createdAt: "2024-01-03T10:50:00Z", metadata: { isSystemMessage: true, earnedStars: 2, isCompletionMessage: true } },
  // Challenge stage
  ...
  { id: "msg_1s2_11", threadId: "thr_1_s2", stageId: "stg_1s2_c", role: "tutor", content: "\u2b50\u2b50\u2b50 Challenge complete!", createdAt: "2024-01-03T11:00:00Z", metadata: { isSystemMessage: true, earnedStars: 3, isCompletionMessage: true } },

  // ========== Thread 1_s3 - Comparing Colonial Regions (COMPLETED - 3 stars) ==========
  ...
  { id: "msg_1s3_2", threadId: "thr_1_s3", stageId: "stg_1s3_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-03T11:15:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  // Walkthrough stage
  ...
  { id: "msg_1s3_5", threadId: "thr_1_s3", stageId: "stg_1s3_w", role: "tutor", content: "\u2b50\u2b50 Walkthrough complete", createdAt: "2024-01-03T11:30:00Z", metadata: { isSystemMessage: true, earnedStars: 2, isCompletionMessage: true } },
  // Challenge stage
  ...
  { id: "msg_1s3_7", threadId: "thr_1_s3", stageId: "stg_1s3_c", role: "tutor", content: "\u2b50\u2b50\u2b50 Challenge complete!", createdAt: "2024-01-03T12:00:00Z", metadata: { isSystemMessage: true, earnedStars: 3, isCompletionMessage: true } },

  // ========== Thread 1_s4 - Timeline Construction (COMPLETED - 3 stars) ==========
  ...
  { id: "msg_1s4_2", threadId: "thr_1_s4", stageId: "stg_1s4_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-03T12:15:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  // Walkthrough stage
  ...
  { id: "msg_1s4_5", threadId: "thr_1_s4", stageId: "stg_1s4_w", role: "tutor", content: "\u2b50\u2b50 Walkthrough complete", createdAt: "2024-01-03T12:30:00Z", metadata: { isSystemMessage: true, earnedStars: 2, isCompletionMessage: true } },
  // Challenge stage
  ...
  { id: "msg_1s4_7", threadId: "thr_1_s4", stageId: "stg_1s4_c", role: "tutor", content: "\u2b50\u2b50\u2b50 Challenge complete!", createdAt: "2024-01-03T13:00:00Z", metadata: { isSystemMessage: true, earnedStars: 3, isCompletionMessage: true } },

  // ========== Thread 1_s5 - Persuasive Essay Writing (COMPLETED - 3 stars) ==========
  ...
  { id: "msg_1s5_2", threadId: "thr_1_s5", stageId: "stg_1s5_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-03T13:15:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  // Walkthrough stage
  ...
  { id: "msg_1s5_5", threadId: "thr_1_s5", stageId: "stg_1s5_w", role: "tutor", content: "\u2b50\u2b50 Walkthrough complete", createdAt: "2024-01-03T13:30:00Z", metadata: { isSystemMessage: true, earnedStars: 2, isCompletionMessage: true } },
  // Challenge stage
  ...
  { id: "msg_1s5_7", threadId: "thr_1_s5", stageId: "stg_1s5_c", role: "tutor", content: "\u2b50\u2b50\u2b50 Challenge complete!", createdAt: "2024-01-03T14:00:00Z", metadata: { isSystemMessage: true, earnedStars: 3, isCompletionMessage: true } },

  // ========== Thread 1_c1 - Was Colonial America a Land of Opportunity? (COMPLETED - 3 stars) ==========
  ...
  { id: "msg_1c1_2", threadId: "thr_1_c1", stageId: "stg_1c1_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-04T09:15:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  // Walkthrough stage
  ...
  { id: "msg_1c1_5", threadId: "thr_1_c1", stageId: "stg_1c1_w", role: "tutor", content: "\u2b50\u2b50 Walkthrough complete", createdAt: "2024-01-04T09:30:00Z", metadata: { isSystemMessage: true, earnedStars: 2, isCompletionMessage: true } },
  // Challenge stage
  ...
  { id: "msg_1c1_7", threadId: "thr_1_c1", stageId: "stg_1c1_c", role: "tutor", content: "\u2b50\u2b50\u2b50 Challenge complete!", createdAt: "2024-01-04T10:00:00Z", metadata: { isSystemMessage: true, earnedStars: 3, isCompletionMessage: true } },

  // ======================================================================
  //  UNIT 2 MESSAGES - REVOLUTIONARY WAR (MIXED PROGRESS)
  // ======================================================================

  // ========== Thread 2_k1 - Causes of Revolution (COMPLETED - 3 stars) ==========
  ...
  { id: "msg_2k1_2", threadId: "thr_2_k1", stageId: "stg_2k1_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-06T09:15:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  // Walkthrough stage - rich Socratic tutor flow
  ...
  { id: "msg_2k1_9", threadId: "thr_2_k1", stageId: "stg_2k1_w", role: "tutor", content: "\u2b50\u2b50 Walkthrough complete", createdAt: "2024-01-06T09:50:00Z", metadata: { isSystemMessage: true, earnedStars: 2, isCompletionMessage: true } },
  // Challenge stage
  ...
  { id: "msg_2k1_11", threadId: "thr_2_k1", stageId: "stg_2k1_c", role: "tutor", content: "\u2b50\u2b50\u2b50 Challenge complete!", createdAt: "2024-01-06T10:00:00Z", metadata: { isSystemMessage: true, earnedStars: 3, isCompletionMessage: true } },

  // ========== Thread 2_k2 - Boston Tea Party (COMPLETED - 3 stars) ==========
  ...
  { id: "msg_2k2_2", threadId: "thr_2_k2", stageId: "stg_2k2_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-06T10:15:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  // Walkthrough stage
  ...
  { id: "msg_2k2_5", threadId: "thr_2_k2", stageId: "stg_2k2_w", role: "tutor", content: "\u2b50\u2b50 Walkthrough complete", createdAt: "2024-01-06T10:30:00Z", metadata: { isSystemMessage: true, earnedStars: 2, isCompletionMessage: true } },
  // Challenge stage
  ...
  { id: "msg_2k2_7", threadId: "thr_2_k2", stageId: "stg_2k2_c", role: "tutor", content: "\u2b50\u2b50\u2b50 Challenge complete!", createdAt: "2024-01-06T11:00:00Z", metadata: { isSystemMessage: true, earnedStars: 3, isCompletionMessage: true } },

  // ========== Thread 2_k3 - Declaration of Independence (2 stars - walkthrough done, on challenge) ==========
  ...
  { id: "msg_2k3_2", threadId: "thr_2_k3", stageId: "stg_2k3_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-06T11:15:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  // Walkthrough stage - rich Socratic tutor flow
  ...
  { id: "msg_2k3_9", threadId: "thr_2_k3", stageId: "stg_2k3_w", role: "tutor", content: "\u2b50\u2b50 Walkthrough complete", createdAt: "2024-01-06T11:50:00Z", metadata: { isSystemMessage: true, earnedStars: 2, isCompletionMessage: true } },
  ...
  // ========== Thread 2_k4 - Key Battles (1 star - begin done, on walkthrough) ==========
  ...
  { id: "msg_2k4_2", threadId: "thr_2_k4", stageId: "stg_2k4_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-06T12:15:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  // Walkthrough just started
  ...
  // Thread 2_k5 - Foreign Alliances (0 stars - NOT STARTED) - no messages
  // Thread 2_k6 - Treaty of Paris (0 stars - NOT STARTED) - no messages

  // ========== Thread 2_s1 - Analyzing Political Cartoons (COMPLETED - 3 stars) ==========
  ...
  { id: "msg_2s1_2", threadId: "thr_2_s1", stageId: "stg_2s1_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-07T09:15:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  // Walkthrough stage - rich Socratic tutor flow
  ...
  { id: "msg_2s1_9", threadId: "thr_2_s1", stageId: "stg_2s1_w", role: "tutor", content: "\u2b50\u2b50 Walkthrough complete", createdAt: "2024-01-07T09:50:00Z", metadata: { isSystemMessage: true, earnedStars: 2, isCompletionMessage: true } },
  // Challenge stage
  ...
  { id: "msg_2s1_11", threadId: "thr_2_s1", stageId: "stg_2s1_c", role: "tutor", content: "\u2b50\u2b50\u2b50 Challenge complete!", createdAt: "2024-01-07T10:00:00Z", metadata: { isSystemMessage: true, earnedStars: 3, isCompletionMessage: true } },

  // ========== Thread 2_s2 - Comparing Perspectives (2 stars - walkthrough done, on challenge) ==========
  ...
  { id: "msg_2s2_2", threadId: "thr_2_s2", stageId: "stg_2s2_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-07T10:15:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  // Walkthrough stage - rich Socratic tutor flow
  ...
  { id: "msg_2s2_9", threadId: "thr_2_s2", stageId: "stg_2s2_w", role: "tutor", content: "\u2b50\u2b50 Walkthrough complete", createdAt: "2024-01-07T10:50:00Z", metadata: { isSystemMessage: true, earnedStars: 2, isCompletionMessage: true } },
  // Challenge stage - student working on it
  ...
  // ========== Thread 2_s3 - Evaluating Primary Sources (1 star - begin done, on walkthrough) ==========
  ...
  { id: "msg_2s3_2", threadId: "thr_2_s3", stageId: "stg_2s3_b", role: "tutor", content: "\u2b50 Begin complete", createdAt: "2024-01-07T11:15:00Z", metadata: { isSystemMessage: true, earnedStars: 1, isCompletionMessage: true } },
  // Walkthrough just started
  ...
  // Thread 2_s4 - Cause and Effect Diagrams (0 stars - NOT STARTED) - no messages
  // Thread 2_s5 - Argumentative Writing (0 stars - NOT STARTED) - no messages
  // Thread 2_c1 - Was the Revolution Inevitable? (0 stars - NOT STARTED) - no messages
];
