...
// Picker order: general (default) first, then warm → cool color wheel
...
/**
 * Per-subject accent colors. Warm subjects (art/math/history) use warm hues;
 * cool subjects (science/globe/computer/music) use cool hues.
 * Math uses amber — distinct from general (purple) and music (indigo).
 */
export const COURSE_COLORS: Record<string, { main: string; light: string }> = {
  general:  { main: "#5a7a8e", light: "rgba(90,122,142,0.08)"  },  // slate   (neutral default)
  art:      { main: "#c47a8a", light: "rgba(196,122,138,0.08)" },  // rose    (creative)
  math:     { main: "#c07840", light: "rgba(192,120,64,0.08)"  },  // amber   (analytical energy)
  history:  { main: "#b08d57", light: "rgba(176,141,87,0.08)"  },  // gold    (antiquity)
  religion: { main: "#a39e72", light: "rgba(163,158,114,0.08)" },  // olive   (earthy)
  science:  { main: "#5c8f6a", light: "rgba(92,143,106,0.08)"  },  // sage    (nature)
  globe:    { main: "#5a9e8f", light: "rgba(90,158,143,0.08)"  },  // teal    (world/ocean)
  computer: { main: "#5b7fa6", light: "rgba(91,127,166,0.08)"  },  // steel   (technology)
  music:    { main: "#8a3a60", light: "rgba(138,58,96,0.08)"   },  // wine    (creative/expressive)
};
